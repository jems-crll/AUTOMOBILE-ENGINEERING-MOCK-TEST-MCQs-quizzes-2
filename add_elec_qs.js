...
// Fix Electrical Set names for the existing ones
content = content.replace('"Electrical Set 2 (Q 1 - 25)"', '"Electrical Set 2 (Q 26 - 50)"');
content = content.replace('"Electrical Set 3 (Q 1 - 25)"', '"Electrical Set 3 (Q 51 - 77)"');
...
// Inject new chapter before the end of the CHAPTERS array
content = content.replace(/\s*\];\s*export const QUESTIONS: Question\[\] = \[/g, `,\n${newChapter}\n];\n\nexport const QUESTIONS: Question[] = [`);
